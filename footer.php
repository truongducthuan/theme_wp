...
<div class="flex flex-col py-10 lg:py-24 w-full bg-white max-lg:px-5 max-lg:max-w-full">
  <div class="max-w-[1200px] mx-auto w-full">
    <div class="flex flex-wrap gap-10 justify-between items-center w-full max-lg:max-w-full">
      <div class="footer-logo flex items-start self-stretch w-fit lg:min-w-[240px] lg:w-[342px]"><a href="/">
    ...
    <div
      ...
      <div class="flex gap-4 order-1 lg:order-2">
        ...
        <div class="flex gap-4 items-center my-auto">
          ...
          <a href="https://www.facebook.com/pages/%E3%82%A8%E3%82%A4%E3%82%B8%E3%83%A9%E3%83%9C%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE/104975738971910/"
            class="footer-social">
            <img loading="lazy"
