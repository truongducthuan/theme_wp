...
<section class="relative">
  <div class="relative">
    ...
    <div class="max-w-[1200px] mx-auto px-5 lg:px-0 pt-32 lg:pt-60 z-10 relative text-[#B2B2B2]">
      <div class="flex gap-3 items-center self-start text-base text-white mb-5 lg:mb-10">
        <div class="flex shrink-0 self-stretch my-auto w-2.5 h-2.5 bg-red-600 rounded-full"></div>
      ...
      <div class="flex justify-end items-end gap-4 mt-5 lg:mt-20 mb-10 w-full text-white"><span>Top -</span>
        <p>会社概要</p>
      </div>
    </div>
    ...
    <div class="relative w-full z-10 text-[#B2B2B2]">
      <div
        class="absolute right-0 lg:left-80 xl:left-[19rem] top-0 lg:-top-5 flex-col w-[70%] lg:w-[84%] mb-[80px] bg-gradient-to-t from-black to-inherit">
    ...
    <div
      class="flex flex-col lg:flex-row justify-between items-center text-[#B2B2B2] mt-20 lg:mt-[9rem] mb-10 w-full relative">
        ...
        <div class="swiper mySwiperPhone">
          ...
          if(!empty($we_do)):
            ...
            <div class="swiper-slide">
              <div class="h-full clip-path--right"><img loading="lazy" src="<?php echo $img; ?>"
                  class="object-contain w-full h-full" /></div>
            </div>
            <?php 
            endforeach;
          endif;
    ...
    <div
      class="text-[#B2B2B2] pt-10 lg:pt-44 max-w-[1200px] mx-auto px-5 lg:px-0 flex flex-col lg:flex-row justify-between gap-5 relative z-20">
  ...
  ?>
    ...
    ?>
        <div
          class="flex justify-start items-center gap-10 py-5 <?php echo $index == $count - 1 ? 'divide-bottom' : ''; ?>">
