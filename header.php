...
<body <?php body_class(); ?> class="relative">
  ...
  <main class="w-full h-full hero-pattern bg-[#222222] relative">
    <div class="w-full relative">
      <div
        class="site-header flex justify-between items-center header fixed top-5 lg:-top-24 left-5 lg:left-0 right-5 lg:right-0 z-30 max-w-[1200px] mx-auto flex-wrap bg-white min-h-[60px] lg:min-h-[80px] rounded-[100px] max-lg:max-w-full">
        <a href="<?php echo esc_url(home_url('')); ?>"
          class="_logo flex overflow-hidden gap-2 items-start ml-5 my-auto">
          <!-- Left -->
          <div class="flex gap-1 items-center py-2">
            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/svg/Logo.svg"
        ...
        <div class="hidden lg:flex gap-10 items-center">
          <div class="flex justify-between items-center gap-10" id="menus-top">
            <a href="<?php echo esc_url(home_url('/our-business')); ?>"
      ...
      <div class="block lg:hidden absolute top-0 -right-[100%] bottom-0 left-0 bg-grba z-50" id="navbar">
        <div
          class="p-8 bg-white flex justify-start fixed top-1 -right-[100%] bottom-1 lg:top-8 lg:right-8 lg:bottom-8 w-[300px] lg:w-[400px] lg:h-buttom rounded-2xl gap-5 overflow-y-auto scrollbar-custom">
          ...
          <ul class="w-full divide-y">
            <li class="flex justify-between items-center py-5">
              <a href="<?php echo esc_url(home_url()); ?>"
                class="text-center hover:scale-110 hover:animate-pulse cursor-pointer transition-all duration-300">
                <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/svg/Logo.svg"
                  class="object-contain shrink-0 self-stretch my-auto" />
              </a>

              <div class="p-1 cursor-pointer hover:bg-secondary close-nav"><i class="fa-solid fa-xmark text-2xl"></i>
              </div>
            </li>
            <li class="hover:bg-[#f20c5d08] hover:translate-x-3 cursor-pointer transition-all duration-300">
              <a href="<?php echo esc_url(home_url('/our-business')) ?>"
                class="flex justify-between items-center py-4 w-full">
                <p class="capitalize font-semibold">事業内容</p>
                <i class="fa-solid fa-angle-right text-primary"></i>
              </a>
            </li>
            <li
              class="flex justify-between items-center hover:bg-[#f20c5d08] hover:translate-x-3 py-4 cursor-pointer transition-all duration-300"
              id="scroll-class">
            ...
            <li class="pt-5 pb-5 border-none">
              <div>
                <a href="<?php echo esc_url(home_url('/contact-form')); ?>">
                  <div
                    class="gap-2.5 self-stretch px-5 py-3.5 text-white text-center my-auto hover:border-[1px] hover:border-solid hover:border-neutral-900 hover:bg-neutral-300 hover:text-neutral-900 bg-neutral-900 min-h-[45px] rounded-[100px] w-full max-lg:px-5 transition-all">
                    お問い合わせ</div>
                </a>
              </div>
            </li>
            <li class="pb-5 border-none">
              <div>
                <a href="<?php echo esc_url(home_url('/document-request')); ?>">
                  <div
                    class="gap-2.5 self-stretch px-5 py-3.5 text-white text-center my-auto hover:border-[1px] hover:border-solid hover:border-blue-900 hover:bg-blue-300 hover:text-blue-900 bg-blue-900 min-h-[45px] rounded-[100px] w-full max-lg:px-5 transition-all">
                    資料請求</div>
                </a>
              </div>
            </li>
