...
<section>
  <div class="relative">
    ...
    <div class="max-w-[1200px] mx-auto pt-32 lg:pt-60 px-5 lg:px-0 z-10 relative">
      <div class="flex gap-3 items-center self-start text-base text-white mb-10">
        <div class="flex shrink-0 self-stretch my-auto w-2.5 h-2.5 bg-red-600 rounded-full"></div>
        <div class="self-stretch my-auto">プライバシーポリシー</div>
      </div>
      ...
      <div class="flex justify-end items-end gap-4 mt-16 lg:mt-20 mb-10 w-full text-white">
        <span>Top ー</span>
        <p>プライバシーポリシー</p>
      </div>
