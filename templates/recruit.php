  ...
  <div class="max-w-[1200px] mx-auto pt-60 z-10 relative text-[#B2B2B2]">
    ...
    <div class="flex justify-between gap-4">
      <div class="flex flex-col items-start justify-start self-start gap-8 text-white py-1 rounded-xl">
        <div class="font-bold text-8xl text-white uppercase">RECRUIT</div>
      </div>
    </div>
    ...
    <div class="flex justify-end items-end gap-4 mt-20 mb-10 w-full text-white"><span>Top -</span><p>採用情報 </p></div>
  </div>
    ...
    <div class="relative">
      ...
      <div class="max-w-[1200px] mx-auto">
        <div class="relative">
          ...
          <div class="absolute -bottom-[14rem] -left-[9rem] w-full mix-blend-exclusion">
            <!-- <img src="<?php // echo get_template_directory_uri() ?>/assets/svg/JOIN US.svg" alt="join us" class="w-full opacity-[0.1]" > -->
      ...
      <div class="relative my-36">
        <div class="absolute -left-1 -bottom-[140px] w-[50%]">
          ...
          <div class="absolute -right-1 w-[40%] -bottom-[160px]">
        ...
        ?>
        <div class="max-w-[1200px] mx-auto text-[#B2B2B2] relative z-10">
          ...
          ?>
            <div class="flex justify-start items-center gap-10 py-5 <?php echo $index == $count - 1 ? 'divide-bottom' : ''; ?>">
              ...
              <div class="text-[#B2B2B2] mr-16 leading-10"><?php echo $item['value']; ?></div>
            </div>
