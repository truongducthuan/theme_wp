    <!-- Footer -->
    <footer class="bg-robot-green text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h3 class="text-2xl font-bold mb-4">Thông tin liên hệ</h3>
                    <p class="mb-2">129 Duong ABC, Quận 1</p>
                    <p class="mb-4">TP. HCM</p>
                    
                    <p class="mb-2">173 Quong ABC, Quận 1, TP HCM</p>
                    <p class="mb-2">(013) 145-6769</p>
                    <p class="mb-4">info@yourcenter.edu</p>
                </div>
