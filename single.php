...
<div class="relative">
  <div class="flex absolute left-0 top-0 flex-col mt-[60px] mb-[80px] w-[36%] max-lg:ml-0 max-lg:w-full">
  <img
    loading="lazy"
...
<section class="relative z-10 pb-28 pt-32 lg:pt-60 max-w-[1200px] px-5 lg:px-0 mx-auto flex flex-col items-center justify-center rounded-lg news_post">
  <div class="flex flex-col items-start justify-start self-start gap-8 text-white py-1 rounded-xl">
    ...
    <div><a class="font-bold text-3xl lg:text-6xl" href="<?php echo get_permalink(); ?>"><?php echo the_title(); ?></a></div>
 ...
  <div class="flex justify-end items-end gap-4 my-0 lg:my-10 w-full text-white"><span>Top  実績 </span><p><?php echo the_title(); ?></p></div>

  <div class="bg-[#353333] p-5 lg:p-16 text-white rounded-xl my-10 lg:my-16 mb-2 lg:mb-8 w-full new_content">
