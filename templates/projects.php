...
<main class="container mx-auto px-4 py-8 pt-20 xl:pt-28">
    ...
    ?>
    <!-- Header Section -->
    <header class="bg-primary py-12 px-4">
                        ...
                        <div class="block">
                            <div class="flex flex-col md:flex-row items-center gap-8 pr-6">
                                <div class="w-full md:w-1/3 overflow-hidden rounded-lg">
                                    <?php the_post_thumbnail('thumbnail', ['class' => 'w-full h-64 object-cover rounded-lg hover:scale-105 ease-in-out hover:shadow-xl transition duration-300']); ?>
                                </div>
