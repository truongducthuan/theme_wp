      ...
      <div class="slide-in-right">
        ...
        <div class="space-y-6">
          ...
          <div class="contact-card flex items-start gap-4 fade-in" style="animation-delay: 0.2s">
            <div class="bg-blue-600 rounded-2xl p-4 flex-shrink-0 icon-bounce">
            ...
            <div>
              ...
              <a href="tel:+00918880002222" class="text-2xl font-bold text-gray-900 hover:text-blue-600 transition-colors">
                +(009) 1888 000 2222
              </a>
            </div>
          </div>
          ...
          <div class="contact-card flex items-start gap-4 fade-in" style="animation-delay: 0.4s">
            <div class="bg-blue-600 rounded-2xl p-4 flex-shrink-0 icon-bounce" style="animation-delay: 0.5s">
              <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <a href="mailto:info@techin.com" class="text-2xl font-bold text-gray-900 hover:text-blue-600 transition-colors">
                info@techin.com
              </a>
            </div>
          </div>
          ...
          <div class="contact-card flex items-start gap-4 fade-in" style="animation-delay: 0.6s">
            <div class="bg-blue-600 rounded-2xl p-4 flex-shrink-0 icon-bounce" style="animation-delay: 1s">
              <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
